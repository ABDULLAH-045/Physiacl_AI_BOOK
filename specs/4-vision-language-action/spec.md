...
As a student, I want to integrate the entire VLA pipeline—from voice input to LLM planning to ROS 2 action execution—so that I can build a fully autonomous humanoid system that completes tasks in a simulated environment.
